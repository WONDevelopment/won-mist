...
var getPeerCount = function() {
  web3.won.net.getPeerCount().then(function(peerCount) {
...
updateBalances = function() {
  ...
  _.each(walletsAndContracts, function(account) {
    if (account.address) {
      web3.won.getBalance(account.address, function(err, res) {
        if (!err) {
          // is of type wallet
...
observeLatestBlocks = function() {
  ...
  web3.won.subscribe('newBlockHeaders', function(e, res) {
    if (!e) {
      updateBalances();
    }
  });
