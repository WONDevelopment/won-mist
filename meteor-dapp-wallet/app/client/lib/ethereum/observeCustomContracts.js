  ...
  collectionObservers[collectionObservers.length] = CustomContracts.find(
    ...
    */
    added: function(newDocument) {
      ...
      web3.won.getCode(newDocument.address, function(e, code) {
        if (!e && code && code.length > 2) {
          ...
          web3.won.getBalance(newDocument.address, function(e, balance) {
...
//     var contractInstance = new web3.won.Contract(newDocument.jsonInterface, newDocument.address);
...
//                 Events.remove(id);
//             } else {
//                 web3.won.getBlock(log.blockHash, function(err, block){
//                     if(!err) {
